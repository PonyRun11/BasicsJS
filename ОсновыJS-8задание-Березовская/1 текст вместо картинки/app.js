...
function showMoreText(card) {
    ...
    let myText = "Consectetur veniam mollit pariatur commodo nulla enim consequat deserunt";
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${myText}</div>`);
